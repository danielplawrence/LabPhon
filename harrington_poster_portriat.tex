...
\end{tabular}
  \end{table}
 \vspace*{-1cm}
\section*{\textipa{/u/} and /o/ fronting in York}
\normalsize
\begin{itemize}
\item{Both /o/ and \textipa{/u/} are undergoing diachronic fronting in York.}
...
\vspace*{0.5cm}
\item{This variability is related to characteristics of the listener :\vspace*{0.5cm}\begin{itemize}\item{Younger, more mobile listeners are more sensitive to \textipa{/u/} variation as an index of social class than older, less mobile listeners.}\item{Controlling for age, more mobile listeners are more sensitive to /o/ diphthongization as an index of social class than less mobile listeners.}\end{itemize}}
\end{enumerate}
