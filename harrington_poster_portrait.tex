...
\end{tabular}
  \end{table}
 \vspace*{-1cm}
\section*{\textipa{/u/} and \textipa{/o/} fronting in York}
\normalsize
\begin{itemize}
\item{Both \textipa{/o/} and \textipa{/u/} are undergoing diachronic fronting in York.}
\item{\textipa{/u/} is becoming less diphthongal.}
\item{\textipa{/o/} diphthongization varies as a function of socioeconomic status.}
...
\raggedright\textit{Figure 1: \textipa{\textipa{/u/}} variants tested (too/food)}\\
...
\normalsize
\vspace*{1cm}
\raggedright\textit{Figure 2: \textipa{\textipa{/o/}} variants tested (toast/so)}\\
\vspace*{-0.25cm}
\centering
...
\begin{itemize}
\item{Listeners perceive back \textipa{/u/} variants as more `working-class' than fronted variants.}
\item{Additionally, there is a weak effect of \textipa{/u/} diphthongization, with diphthongal variants heard as more `working-class' than monophthongs.}
\item{Monophthongal \textipa{/o/} variants cue `working-class' selections.}
\item{Diphthongal \textipa{/o/} variants cue `middle-class' selections, with the exception of the back diphthongal variant \textipa{[oU]}.}
...
\end{itemize}
\vspace*{-1cm}
\subsubsection*{\textipa{/u/}: Younger, more mobile listeners are more sensitive to fronting as an index of social class than older, less mobile listeners.}
\hspace*{-1cm}
\includegraphics[scale=2]{u_perception_age_sd.pdf}
\includegraphics[scale=2]{u_perception_dim3_sd.pdf}
\vspace*{-1.5cm}
\subsubsection*{\textipa{/o/}: More mobile listeners are more sensitive to diphthongization as an index of social class than less mobile listeners.}
\centering
...
\vspace*{0.5cm}
\item{This variability is related to characteristics of the listener:\vspace*{0.5cm}\begin{itemize}\item{Younger, more mobile listeners are more sensitive to \textipa{/u/} variation as an index of social class than older, less mobile listeners.}\item{Controlling for age, more mobile listeners are more sensitive to \textipa{/o/} diphthongization as an index of social class than less mobile listeners.}\end{itemize}}
\end{enumerate}
